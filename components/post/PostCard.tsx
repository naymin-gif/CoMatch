...
export default function PostCard({
  ...
  const effectiveIsOwner =
    isOwner || (Boolean(ownerId) && currentUserId === ownerId);

  const displayedRoles = rolesSeeMore
    ? rolesAndPositions
    : rolesAndPositions.slice(0, 3);
  const baseUrl =
  ...
  return (
    ...
    >
      ...
      <CardContent
        className={`flex flex-col gap-3 ${!postImageUrl ? 'min-h-[500px]' : ''}`}
      >
        {/* Title */}
        ...
        <div>
          ...
          >
            ...
            {isMounted && (
              ...
              >
                <DrawerHeader className="font-heading">Comments</DrawerHeader>
