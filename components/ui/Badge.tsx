...
export default function Badge({ 
  ...
  const baseStyle = "inline-flex items-center justify-center px-3 py-1 text-sm font-medium rounded-pill";
  ...
  const variants: Record<BadgeVariant, string> = {
    ...
    outline: "border border-comatch-primary text-comatch-primary bg-transparent",
