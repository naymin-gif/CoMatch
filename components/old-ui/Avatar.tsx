...
export default function Avatar({
  ...
  const baseStyle =
    'relative inline-flex items-center justify-center rounded-full overflow-hidden bg-comatch-light text-comatch-primary font-bold shrink-0';
  ...
  return (
    <div className={`${baseStyle} ${sizes[size]} ${className}`} {...props}>
      {src ? (
